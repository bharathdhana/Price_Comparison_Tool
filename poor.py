...
def scrape_poorvika_product(url):
    ...
    try:
        ...
        product_name = soup.find('h1', {'class': 'center-content_product_name__O9C4s'}).get_text(strip=True)
        
        price_div = soup.find('div', {'class': 'center-content_price_special__LGEjP'})
